...
SCHOOL_SLUG = "sewall-dining-center"
MENU_SLUG   = "executive-chefs-place"
_today      = date.today()
START_DATE  = _today - timedelta(days=_today.weekday()) - timedelta(weeks=2)
MAX_WEEKS   = 6
OUTPUT      = Path(__file__).parent / "data" / "sewall_dining_menus.json"
...
def main() -> None:
    result = {
        "dining_location": "Sewall Dining Center",
        "url": "https://colorado-diningmenus.nutrislice.com/menu/sewall-dining-center/executive-chefs-place",
