...
MAX_WEEKS   = 6
OUTPUT      = Path(__file__).parent / "data" / "village_center_dining_menus.json"
...
def main() -> None:
    result = {
        "dining_location": "Village Center Dining",
        "url": "https://colorado-diningmenus.nutrislice.com/menu/village-center-dining/vc-meal-of-the-day",
